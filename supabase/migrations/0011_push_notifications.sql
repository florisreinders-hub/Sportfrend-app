...
--      copy before running it, don't commit the real value back). Leave
--      duefdlibkeghdskongjd (the Supabase project ref, used in the
--      function URLs below) as-is - that isn't the secret.
--
